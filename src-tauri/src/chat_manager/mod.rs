...
pub use commands::{
    ...
    __cmd__chat_retry_last_user, __cmd__chat_template_export_as_usc, __cmd__create_prompt_template,
    ...
    chat_regenerate, chat_retry_last_user, chat_template_export_as_usc, create_prompt_template,
    delete_prompt_template, export_prompt_template_as_usc, get_app_default_template_id,
    ...
    reset_dynamic_summary_template, reset_help_me_reply_conversational_template,
    reset_help_me_reply_template, retry_dynamic_memory, search_messages, trigger_dynamic_memory,
